import SkiAlertPic from '../images/SkiAlert.png'
    ...
    return (
       <div id='projects' className='projectsContainer'>
          ...
          <div id='projectContainer'>
            <img className='projectImg' src={SkiAlertPic} alt='SkiAlert project'/>
